...
await copyIfExists('login.html', 'login.html');
await copyIfExists('admin-login.html', 'admin-login.html');
await copyIfExists('admin-dashboard.html', 'admin-dashboard.html');
await copyIfExists('student-dashboard.html', 'student-dashboard.html');
await copyIfExists('enrollments.html', 'enrollments.html');
